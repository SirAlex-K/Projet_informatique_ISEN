    ...
    <div className="min-h-screen bg-[#020817] text-white flex">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <h2 className="text-2xl font-bold mb-1">Projets</h2>
          <p className="text-gray-400 text-sm mb-5">Créez et gérez vos projets étudiants</p>
                ...
                <div key={p.id} className="bg-white/[0.03] border border-white/10 rounded-2xl p-5">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`text-xs px-3 py-1 rounded-full font-medium ${
                      p.statut === 'en_cours' ? 'bg-yellow-500/20 text-yellow-400' :
                      p.statut === 'termine'  ? 'bg-green-500/20 text-green-400' :
