...
export default function DatabaseGroups() {
  const groups = [
    {
      id: 1,
      progress: 20,
      ...
      <div className="w-[320px] border-r border-white/10 bg-[#0B1220] flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="p-5 flex items-center justify-between text-2xl text-gray-400 hover:text-white transition">
      ...
      <div className="flex-1">
        ...
        <div className="p-10">
          ...
          <div className="flex gap-4 mb-10">
            ...
            <Link
              to="/groups"
              className="bg-white/[0.05] px-8 py-5 rounded-2xl text-2xl text-gray-400"
            >
